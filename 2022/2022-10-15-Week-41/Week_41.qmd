...
caption <- str_wrap(glue(
  "Graphic: {twitter} @OluwafemOyedele /
  Source: ravelry /
  Code: {github} BB1464/tidytuesday #rstats #tidytuesday"),
  1000)
```
...
```{r}
ggsave(
  'Yarn.png',path = here::here('2022/2022-10-15-Week-41'),width = 16,height = 12,bg='white')
