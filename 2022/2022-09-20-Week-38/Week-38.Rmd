...
```{r}
# CAPTION
caption_text  <- str_glue("Oluwafemi | #TidyTuesday Week 38 | Data: Macedo et al., 2022/BFRO<br>",
...
ggplot() +
  ...
  theme(text=element_text(family=f1, color="white"),
        ...
        plot.caption=element_markdown(family=f2, color="#CCCCDD",hjust=0, size=9.5, margin=margin(t=15)),
