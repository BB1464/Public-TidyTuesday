...
geom_bar(data = full_set %>% filter(direction == "up"),
  ...
  geom_textbox(aes(y = 1.55*10^5,
                   x = 2029,
                   label = "@OluwafemOyedele | #TidyTuesday<br>Sources: rebrickable, wikipedia\n"),
               halign = 1, hjust = 1,
...
# This will save your most recent plot
ggsave(
  'Logo.png',path = here::here('2022/2022-09-06-Week-36'),width = 9,height = 8,dpi = 400,bg='#ced1d5')
