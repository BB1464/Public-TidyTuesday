...
############################################################################
###                                                                      ###
###                TIDYTUESDAY WEEK 16: CROSSWORD PUZZLES                ###
###                                                                      ###
############################################################################
############################################################################
...
df %>%
  ...
  labs(caption="#TidyTuesday week 16  |  Oluwafemi Oyedele",
...
ggsave("2022/2022-04-19-Week-16/2022_16.png", height=6, width=8, bg="#fafafa")
